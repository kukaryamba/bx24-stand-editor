...
export const furnitureCatalog: FurnitureItem[] = [
  // Стулья и кресла
  { id: "300", catalogId: "300", title: "Стул офисный", category: "seating", widthM: 0.5, depthM: 0.5, image: "300_stul_ofisnyy.png" },
  { id: "306", catalogId: "306", title: "Барный стул", category: "seating", widthM: 0.4, depthM: 0.4, image: "306_barnyy_stul.png" },
  ...
  { id: "313", catalogId: "313", title: "Стол круглый", category: "tables", widthM: 0.8, depthM: 0.8, image: "313_stol_kruglyy.png", round: true },
  ...
  { id: "barnaya_stoyka_r", catalogId: "", title: "Барная стойка закруглённая R=1 м", category: "tables", widthM: 1, depthM: 1, image: "barnaya_stoyka_zakruglennaya_R=1m.png" },
  ...
  { id: "320", catalogId: "320", title: "Архивный шкаф 0,5 x 1 x 0,7 м", category: "storage", widthM: 0.5, depthM: 1, image: "320_arhivnyy_shkaf_0,5_h_1_h_0,7m.png" },
  ...
  { id: "340", catalogId: "340", title: "Стеллаж деревянный, 5 полок", category: "storage", widthM: 0.4, depthM: 1, image: "340_stellazh_derevyannyy_5_polok.png" },
  ...
  // Стены и двери
  { id: "wall_1", catalogId: "", title: "Элемент стены 1 x 2,5 м", category: "walls", widthM: 1, depthM: 0.1, image: "element_steny_1h2,5m.png" },
  ...
  { id: "door_slide", catalogId: "", title: "Дверь раздвижная", category: "walls", widthM: 1, depthM: 0.2, image: "dverj_razdvizhnaya.png" },

  // Освещение
  { id: "515", catalogId: "515", title: "Светильник галогеновый", category: "lighting", widthM: 0.2, depthM: 0.2, image: "515_svetiljnik_galogenovyy.png" },
  ...
  // Электрика
  { id: "rozetka_220", catalogId: "", title: "Розетка 1,5 кВт 220 В", category: "power", widthM: 0.2, depthM: 0.2, image: "rozetka_1,5_kvt_220v.png" },
  ...
  { id: "holodilnik", catalogId: "", title: "Холодильник 150 л", category: "equipment", widthM: 0.6, depthM: 0.6, image: "holodiljnik_150l.png" },

  // Прочее
  { id: "331", catalogId: "331", title: "Настенная вешалка", category: "other", widthM: 0.6, depthM: 0.1, image: "331_nastennaya_veshalka.png" },
  { id: "332", catalogId: "332", title: "Напольная вешалка", category: "other", widthM: 0.5, depthM: 0.5, image: "332_napoljnaya_veshalka.png" },
  { id: "377", catalogId: "377", title: "Корзина для мусора", category: "other", widthM: 0.3, depthM: 0.3, image: "377_korzina_dlya_musora.png" },
