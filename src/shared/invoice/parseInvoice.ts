...
const itemRules: Array<[RegExp, string | string[]]> = [
  ...
  [/(стол.*кругл|кругл\S*\s+стол|стол).*(\b[dд]\s*-?\s*)?(80\s*см|0[,.]8\s*м|[dд]\s*-?\s*80)/, "stol-kruglyy-d80"],
  [/(стол.*кругл|кругл\S*\s+стол).*(70|0[,.]7)/, "stol-kruglyy-d70"],
  [/стол\s+кругл|кругл\S*\s+стол/, ["stol-kruglyy-d70", "stol-kruglyy-d80"]],
  ...
  [/стеллаж.*металл|металл\S*\s+стеллаж/, "stellazh-metallicheskiy"],
  [/стеллаж.*пласт/, "stellazh-plastmassovyy"],
  [/стеллаж/, ["stellazh-metallicheskiy", "stellazh-plastmassovyy"]],
